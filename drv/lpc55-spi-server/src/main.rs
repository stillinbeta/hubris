...
//
// TODO: SP should be able to send a message to resync the RoT communications.
// To support that semantic, the RoT will always
// process incoming bytes even if it is transmitting a previously queued
// message.
// TODO: properly test that case.
//
        ...
        loop {
            ...
            if tctx.rot_irq && tctx.state == TxState::Finish {
                ...
                // spi.txerr_clear();
                    ...
                    // reacting to txempty.
                    // TODO: We could relax when all our data is in FIFOWR
                    // and take an interrupt on txempty.
                }
            }
